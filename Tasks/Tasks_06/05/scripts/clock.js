...
// This namespace manages the display and functionality of the clocks
(function ($) {
    ...
    var Clock = {
        ...
        tick: function () {
            ...
            var updateClockAtIndex = function (index, element) {
                var zone = zones[index],
                    formattedTime = this.convertAndFormatDate(
                        zone.offset,
                        date
                    );
        ...
        convertAndFormatDate: function (offset, date) {
            var convertedSeconds =
                ...
                seconds = Math.abs(Math.floor(date.getUTCSeconds()));
            if (hour < 0) {
                hour = hour + 24;
            } else if (hour >= 24) {
                hour = hour - 24;
